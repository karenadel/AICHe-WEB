...
function handleWorkshopSubmit(
  ...
  if (workshopId) {
    ...
    if (
      ...
      alert(
        "You don't have permission to edit workshops."
      );
  ...
  // ----------------------------------------------------------
    ...
    if (
      ...
      alert(
        "You don't have permission to add workshops."
      );
...
function deleteWorkshop(
  ...
  if (
    ...
    alert(
      "You don't have permission to delete workshops."
    );
...
function viewWorkshop(
  ...
  window.location.href =
    `workshop-management-details.html?id=${workshop.id}`;
}
...
function setupButtonEvents() {
  ...
  if (addWorkshopButton) {
    ...
    addWorkshopButton.addEventListener(
      "click",
      () => {
